...
//
//  This is a box for a switch mode power converter to convert an IKEA desk lamp to run from a USB power supply.
//
...
pcbLength           = 42.25; // front to back (X axis)
pcbWidth            = 20.5; // side to side (Y axis)
pcbThickness        = 1.6; 
...
cutoutsFront =  
[
    [pcbWidth / 2, 0, 0, 0, 1.6, yappCircle, yappCenter]
];

cutoutsBack = 
[
    [pcbWidth / 2, 0, 0, 0, 2, yappCircle, yappCenter]
];
...
snapJoins   =   
[
  [18, 4, yappLeft, yappRight, yappSymmetric]
];
