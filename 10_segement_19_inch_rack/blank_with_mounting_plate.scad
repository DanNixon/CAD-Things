...
module BlankWithMountingPlate(front_thickness=5, plate_thickness=5, plate_depth=120, recess_size=[segment_width - 10, segment_height - 16], recess_depth=3, support_thickness=5, front_support_length=segment_width*0.75, panel_support_length=50)
{
