...
function keyboard_tab_dx() = (keyboard_outer_dims()[0] + MATERIAL_THICKNESS) / 2;
function keyboard_tab_x_positions() = [-keyboard_tab_dx(), keyboard_tab_dx()];

function keyboard_tab_dy_a() = (keyboard_outer_dims()[1] - TAB_WIDTH) / 2;
function keyboard_tab_y_positions_a() = [-keyboard_tab_dy_a(), 0, keyboard_tab_dy_a()];

function keyboard_tab_dy_b() = ((keyboard_outer_dims()[1] * 0.6) - TAB_WIDTH) / 2;
...
function tablet_tab_dx() = (tablet_outer_dims()[0] + MATERIAL_THICKNESS) / 2;
function tablet_tab_x_positions() = [-tablet_tab_dx(), tablet_tab_dx()];

function tablet_tab_dy_a() = (tablet_outer_dims()[1] - TAB_WIDTH) / 2;
function tablet_tab_y_positions_a() = [-tablet_tab_dy_a(), 0, tablet_tab_dy_a()];

function tablet_tab_dy_b() = ((tablet_outer_dims()[1] * 0.6) - TAB_WIDTH) / 2;
